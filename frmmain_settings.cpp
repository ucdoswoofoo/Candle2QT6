...
void frmMain::loadSettings()
{
    ...
    //foreach (StyledToolButton* button, this->findChildren<StyledToolButton*>(QRegularExpression ("cmdUser\\d")))
    {
        ...
        int i = button0->objectName().right(1).toInt();
        m_settings->setUserCommands(i, set.value(QString("userCommands%1").arg(i)).toString());
        StyledToolButton* button1 = ui->cmdUser1;
        int j = button1->objectName().right(1).toInt();
        m_settings->setUserCommands(i, set.value(QString("userCommands%1").arg(j)).toString());
        StyledToolButton* button2 = ui->cmdUser2;
        int m = button2->objectName().right(1).toInt();
        m_settings->setUserCommands(i, set.value(QString("userCommands%1").arg(m)).toString());
        StyledToolButton* button3 = ui->cmdUser3;
        int n = button3->objectName().right(1).toInt();
        m_settings->setUserCommands(i, set.value(QString("userCommands%1").arg(n)).toString());
    }
    // foreach (StyledToolButton* button, this->findChildren<StyledToolButton*>(QRegularExpression ("cmdUser\\d")))
    // {
...
void frmMain::saveSettings()
{
    ...
    StyledToolButton* button1 = ui->cmdUser1;
    int j = button1->objectName().right(1).toInt();
    set.setValue(QString("userCommands%1").arg(i), m_settings->userCommands(j));
    StyledToolButton* button2 = ui->cmdUser2;
    int m = button2->objectName().right(1).toInt();
    set.setValue(QString("userCommands%1").arg(i), m_settings->userCommands(m));
    StyledToolButton* button3 = ui->cmdUser3;
    int n = button3->objectName().right(1).toInt();
    set.setValue(QString("userCommands%1").arg(i), m_settings->userCommands(n));
...
void frmMain::applySettings()
{
    ...
    StyledToolButton* button0 = ui->cmdUser0;
    button0->setToolTip(m_settings->userCommands(button0->objectName().right(1).toInt()));
    button0->setEnabled(!button0->toolTip().isEmpty());
    StyledToolButton* button1 = ui->cmdUser1;
    button1->setToolTip(m_settings->userCommands(button1->objectName().right(1).toInt()));
    button1->setEnabled(!button1->toolTip().isEmpty());
    StyledToolButton* button2 = ui->cmdUser2;
    button2->setToolTip(m_settings->userCommands(button2->objectName().right(1).toInt()));
    button2->setEnabled(!button2->toolTip().isEmpty());
    StyledToolButton* button3 = ui->cmdUser3;
    button3->setToolTip(m_settings->userCommands(button3->objectName().right(1).toInt()));
    button3->setEnabled(!button3->toolTip().isEmpty());
