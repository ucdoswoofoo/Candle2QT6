...
void GLWidget::paintEvent(QPaintEvent *pe) {
    ...
    painter.drawText(QPoint(this->width() - fm.boundingRect(str).width() - 10, y + 30), str);
    str = QString("FPS: %1").arg(m_fps);
    painter.drawText(QPoint(this->width() - fm.boundingRect(str).width() - 10, y + 45), str);

    str = m_spendTime.toString("hh:mm:ss") + " / " + m_estimatedTime.toString("hh:mm:ss");
    painter.drawText(QPoint(this->width() - fm.boundingRect(str).width() - 10, y), str);

    str = m_bufferState;
    painter.drawText(QPoint(this->width() - fm.boundingRect(str).width() - 10, y + 15), str);
